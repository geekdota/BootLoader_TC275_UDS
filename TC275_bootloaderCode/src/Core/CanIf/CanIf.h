...
typedef void (*TxConf)(PduIdType TpPduId); /* daizhunsheng do */
...
typedef struct
{
    ...
    /*const void (*TxConf)(PduIdType TpPduId);*/ /* daizhunsheng do */
    const TxConf TxConf_fun; /* daizhunsheng do */

}CanIf_TxChannelType;

typedef void (*RxInd)(PduIdType TpPduId, const PduInfoType * const CanTp_objRxPtr);/* daizhunsheng do */
typedef struct
{
    ...
    /* const void (*RxInd)(PduIdType TpPduId, const PduInfoType * const CanTp_objRxPtr);*/ /* daizhunsheng do */
    const RxInd RxInd_fun;  /* daizhunsheng do */
