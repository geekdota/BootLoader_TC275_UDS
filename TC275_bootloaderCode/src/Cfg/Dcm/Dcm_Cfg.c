 ...
 *
 *  V1.1    20130517    10086      modified version
 *
 *  V1.2    20130913    10086        update
 *
 *  V1.3    20161015    10086     update

 *  V1.4    20180522    10086         update
 */
/*============================================================================*/
...
const Dcm_RoutineControlRowType Dcm_RoutineControlRow[DCM_ROUTINE_CONTROL_NUM] =
    {
        ...
        {(uint16)0xFF00u, (uint8)0x09u, FALSE,
         ...
         (uint8)DCM_SECURITY_LEV1,
         &Dcm_EraseMemory},
        {/*(uint16)0x0202u, (uint8)SECM_CRC_LENGTH, FALSE,*/ /*10086 mask */
