...
const FL_BlockDescriptorType FL_BlkInfo[FL_NUM_LOGICAL_BLOCKS] =
	{
		...
		{
			0xA0038000U, 0x000400U, (uint16)0xFFFFU}, /* 1K, flash erase and write code, for FEE driver */
#if 0
		{
...
#endif
		{
			0xA0080000U, 0x180000U, (uint16)0xFFFFU}, /* 1.5M, BSW code */
		{
			0xA0200000U, 0x100000U, (uint16)0xFFFFU}, /* 1M, ASW code */
		{
			0xA0340000U, 0x0A0000U, (uint16)0xFFFFU}, /* 640K, calibration data */
		{
			0xA03E0000, 0x0001000U, (uint16)0xFFFFU} /* 4K, UDS DID const data */
};
